...
public class Apoio3 extends ObjetoGiratorio {
	...
	public Apoio3(int cartesianoX, int cartesianoY, int raio) {
		super(Util.getTexto("3_genero"), Util.getCorApoio3());
	...
	public Objeto clone() {
		Apoio3 apoio = new Apoio3(cartesianoX, cartesianoY, 0);
	...
	public void salvarXML(PrintWriter pw) {
		pw.print("\t<apoio3 cX=\"" + cartesianoX + "\" cY=\"" + cartesianoY + "\" v1X=\"" + vetor1.x + "\" v1Y=\"" + vetor1.y + "\" v2X=\"" + vetor2.x + "\" v2Y=\"" + vetor2.y + "\" v3X=\"" + vetor3.x + "\" v3Y=\"" + vetor3.y + "\"/>\r\n");
	}
